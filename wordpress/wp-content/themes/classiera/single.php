					...
					<div class="border-section border details">
                        ...
                        <div class="post-details">
                            <ul class="list-unstyled clearfix">
                                ...
                                <li>
                                    <p class="clearfix"><?php esc_html_e( 'Added', 'classiera' ); ?>: 
								...
								<li>
                                    <p class="clearfix"><?php esc_html_e( 'Sale Price', 'classiera' ); ?>: 
								...
								<li>
                                    <p class="clearfix"><?php esc_html_e( 'Regular Price', 'classiera' ); ?>: 
									<span class="pull-right flip cl__price">
										<?php 
								...
								<li>
                                    <p class="clearfix"><?php esc_html_e( 'State', 'classiera' ); ?>: 
								...
								<li>
                                    <p class="clearfix"><?php esc_html_e( 'City', 'classiera' ); ?>: 
                    ...
                    else
                    {
						$classieraCustomFields = get_post_meta($post->ID, 'custom_field', true);
								...
								<li>
									...
									<span class="pull-right flip">
										<a href="<?php echo esc_url($post_web_url);?>"><?php echo esc_html($post_web_url_txt);?></a>
									</span>
									</p>
                                </li><!--Views-->
								<?php } ?>
								...
								<div class="widget-content widget-content-post">
                                    <div class="contact-details widget-content-post-area">
										...
										<?php }elseif(!empty($post_phone)){ ?>
											<li><i class="fas fa-li fa-phone-square"></i>&nbsp;
												<span class="phNum" data-replace="<?php echo esc_html($post_phone);?>"><?php echo esc_html($post_phone);?></span>
												<button type="button" id="showNum"><?php esc_html_e('Reveal', 'classiera') ?></button>
											</li>
										<?php } ?>
											...
											<?php if(!empty($post_web_url)){ ?>
											<li><i class="fas fa-li fa-globe"></i> 
												<a href="<?php echo esc_url($post_web_url); ?>">
													<?php echo esc_html($post_web_url_txt); ?>
												</a>
											</li>
											<?php } ?>
										<?php if($classieraAuthoremail == true){ ?>
