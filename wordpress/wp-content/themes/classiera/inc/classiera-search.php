...
===========================*/
if (!function_exists('classiera_smart_search')) {
...
if(! function_exists('classiera_location_query')){
	function classiera_location_query($location){
		if(!empty($location)){
			if (is_numeric($location)){
				...
				$locationName = $p->post_title;
				endforeach;
			}else{
				$locationName = $location;
			}
			if(!empty($locationName)){
				$searchlocationQuery = array(
					'relation' => 'OR',
					array(
						'key'     => 'post_location',
						'value'   => $locationName,
...
if(! function_exists('classiera_CF_search_Query')){
...
if(! function_exists('classiera_Country_search_Query')){
...
if(! function_exists('classiera_State_search_Query')){
...
if(! function_exists('classiera_City_search_Query')){
...
===========================*/
if (!function_exists('classiera_Select_currency_dropdow')) {
	function classiera_Select_currency_dropdow($tag){
		...
		<select name="post_currency_tag" id="post_currency_tag" class="post_currency_tag form-control form-control-md">
			...
			<option value="LE" <?php if($tag == 'LE'){echo "selected";}?>>
				<?php esc_html_e('Sierra Leone', 'classiera'); ?>
			</option>
			...
			<option value="TOP" <?php if($tag == 'TOP'){echo "selected";}?>>
				<?php esc_html_e('Tongan Pa&rsquo;anga', 'classiera'); ?>
			</option>
...
===========================*/
if (!function_exists('classiera_Display_currency_sign')) {
...
===========================*/
if (!function_exists('classiera_change_currency_tag')) {
...
===========================*/
if (!function_exists('classiera_post_price_display')) {
