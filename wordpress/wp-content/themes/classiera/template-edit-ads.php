					...
					<form class="form-horizontal" action="" role="form" id="primaryPostForm" method="POST" data-toggle="validator" enctype="multipart/form-data">
									...
									<div class="form-inline row">
										...
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_old_price" value="<?php echo esc_attr($post_old_price); ?>" class="form-control form-control-md" placeholder="<?php esc_html_e('Regular price', 'classiera') ?>">
											</div>
										</div>
										<?php } ?>
									</div><!--form-inline row-->
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="post_phone" value="<?php echo esc_html($post_phone); ?>" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your phone number or Mobile number', 'classiera') ?>">
                                            </div><!--input-group-->
                                        </div><!--col-sm-12-->
                                    </div><!--form-inline row-->
									...
									<div class="form-inline row">
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_web_url" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your website URL', 'classiera') ?>" value="<?php echo esc_url($post_web_url); ?>">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_web_url_txt" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter URL title', 'classiera') ?>" value="<?php echo esc_html($post_web_url_txt); ?>">
											</div>
										</div>
									</div>
								</div>
									...
									for($i = 0; $i < (count($classieraCategoryFields)); $i++){ 
										if($classieraCategoryFieldsType[$i][1] == 'text'){
											...
											<div class="form-group" id="cat-<?php echo esc_attr($thisCatID); ?>">
												<label class="col-sm-3 text-left flip"><?php echo esc_attr($classieraCategoryFields[$i][0]); ?>: <span>*</span></label>
												<div class="col-sm-6">
										...
										<div class="col-sm-6">
											<div class="inner-addon right-addon">
												...
												<select class="form-control form-control-md" id="custom_field[<?php echo esc_attr($i); ?>][1]" name="<?php echo esc_attr($thisCatID); ?>custom_field[<?php echo esc_attr($i); ?>][1]">
													<?php
													echo '<option>'.$classieraCategoryFields[$i][0].'</option>';
										...
										<div class="col-sm-6">
											<div class="inner-addon right-addon">
												...
												<div class="checkbox">
													...
													<label for="<?php echo esc_attr($thisCatID); ?>custom_field[<?php echo esc_attr($i); ?>][1]" class="newcehcklabel"><?php echo esc_attr($classieraCategoryFields[$i][0]); ?></label>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="form-main-section media-detail">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!--dropzone-->
									<div class="dropzone dz-clickable mb-4" id="classiera_editdropzone" data-max-file="<?php echo esc_attr( $imageLimit ); ?>">
                                    ...
                                    <div class="iframe">
                                        ...
                                        <textarea class="form-control" name="video" id="video-code" placeholder="<?php esc_html_e('Put here iframe or video url.', 'classiera') ?>"><?php echo esc_html($post_video); ?></textarea>
                                        <div class="help-block">
						...
						<div class="form-main-section post-location">
											...
											<div class="form-inline row">
												<div class="col-sm-12">
													<div class="input-group">
														...
														<input type="text" name="post_state" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your state name', 'classiera') ?>" value="<?php echo esc_attr($post_state); ?>">
													</div><!--input-group-->
												</div><!--col-sm-12-->
											</div><!--form-inline row-->
										</div><!--col-sm-9-->
											...
											<div class="form-inline row">
												<div class="col-sm-12">
													<div class="input-group">
														...
														<input type="text" name="post_city" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your city name', 'classiera') ?>" value="<?php echo esc_attr($post_city); ?>">
													</div><!--input-group-->
												</div><!--col-sm-12-->
											</div><!--form-inline row-->
										</div><!--col-sm-9-->
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="address" type="text" name="address" value="<?php echo esc_html($post_address); ?>" class="form-control form-control-md" placeholder="<?php esc_html_e('Address or City', 'classiera') ?>" required>
                                </div>
                            </div>
							<?php } ?>
							<!--Address-->
