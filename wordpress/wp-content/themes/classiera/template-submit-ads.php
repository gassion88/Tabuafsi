						...
						<div class="form-main-section post-detail">
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="post_tags" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter keywords for a better search', 'classiera') ?>">
                                            </div>
                                        </div>
                                    </div>
							...
							<div class="form-group classiera_hide_price">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="help-block"><?php esc_html_e('Currency sign is already set as', 'classiera') ?>&nbsp;<?php echo esc_html( $postCurrency ); ?>&nbsp;<?php esc_html_e('Please do not include a currency sign in the price field. Only use numbers, ex: 12345', 'classiera') ?></div>
									<?php } ?>
                                </div>								
                            </div><!--Ad Price-->
							<?php } ?>
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="post_phone" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your phone or mobile number', 'classiera') ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="post_email" class="form-control form-control-md" placeholder="<?php esc_html_e('email@example.com', 'classiera') ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
									...
									<div class="form-inline row">
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_web_url" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your website URL', 'classiera') ?>">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_web_url_txt" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter URL title', 'classiera') ?>">
											</div>
										</div>
									</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="iframe">
                                        ...
                                        <textarea class="form-control" name="video" id="video-code" placeholder="<?php esc_html_e('Paste iframe or video URL here.', 'classiera') ?>"></textarea>
												...
												<div class="form-inline row">
													<div class="col-sm-12">
														<div class="input-group">
															...
															<input type="text" name="post_state" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your state name.', 'classiera') ?>">
														</div><!--input-group-->
													</div><!--col-sm-12-->
												</div><!--form-inline row-->
											</div><!--col-sm-9-->
											...
											<div class="form-inline row">
												<div class="col-sm-12">
													<div class="input-group">
														...
														<input type="text" name="post_city" class="form-control form-control-md" placeholder="<?php esc_html_e('Enter your city name.', 'classiera') ?>">
													</div><!--input-group-->
												</div><!--col-sm-12-->
											</div><!--form-inline row-->
										</div><!--col-sm-9-->
							...
							if($postLimitOn == true && $countPosts >= $regularCount && $currentRole != "administrator"){
								...
								<div class="col-sm-4 col-md-3 col-lg-3 active-post-type">
                                    <div class="post-type-box">
										...
										<?php echo esc_attr($classieraRegularAdsDays); ?>
										<?php
